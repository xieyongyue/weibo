...
@interface BuyViewController ()<UICollectionViewDataSource, UICollectionViewDelegate>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.leftview.pricelabel.text = [NSString stringWithFormat:@"￥%.1f原价:￥%@",[self.listArray[indexPath.row ][@"now_price"] floatValue], self.listArray[indexPath.row][@"origin_price"]];
